...
Untuk menjalankan script pengujian wajib yang menghasilkan file Excel dan histogram, gunakan perintah `python benchmark/run\_tests.py`. Hasilnya akan tersimpan di folder benchmark/output/ berupa hasil\_pengujian.xlsx dan histogram\_byte.png
